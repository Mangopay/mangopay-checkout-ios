...
public class ListCustomerCardsQuery: GraphQLQuery {
  ...
  public struct Data: SchemaPackage.SelectionSet {
    ...
    public struct ListCustomerCard: SchemaPackage.SelectionSet {
      public let __data: DataDict
      public init(data: DataDict) { __data = data }

      public static var __parentType: ParentType { SchemaPackage.Objects.PaymentMethod }
      public static var __selections: [Selection] { [
