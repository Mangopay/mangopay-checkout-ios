Pod::Spec.new do |s|
    ...
    s.source_files = 'MangoPaySdkAPI/Clients/*.swift', 'MangoPaySdkAPI/Models/*.swift', 'MangoPaySdkAPI/Networking/REST/*.swift', 'MangoPaySdkAPI/Extensionsg.swift'
