...
/**
 The NTHRegisterMode enum provides constants for the data collecting options for a textField when
 is registered.
 .NoneData - None behavioral and none text data will be collected
 .ContentFree - None text data, only behavioral data will be collected
